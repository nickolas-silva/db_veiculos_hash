...
s.addVeiculo(new Veiculo("ABC-1234", "SwiftSport", 2020, "12345678901", "João Silva", 987652101));
...
s.addVeiculo(new Veiculo("JKL-7890", "Range Rover Evoque", 2023, "56789012345", "Rafael Almeida", 541098745));
s.addVeiculo(new Veiculo("MNO-2345", "Wrangler Sahara", 2020, "67890123456", "Julia Carvalho", 431987656));
s.addVeiculo(new Veiculo("PQR-6789", "A4 Quattro", 2022, "78901234567", "Lucas Ferreira", 309876567));
...
s.addVeiculo(new Veiculo("NOP-7890", "X5 M", 2023, "54321098765", "André Carvalho", 443322110));
...
s.addVeiculo(new Veiculo("RST-7890", "3 Series", 2018, "65432109876", "Vinícius Ferreira", 332211009));
...
s.addVeiculo(new Veiculo("CDE-4567", "Forte GT", 2017, "10987654321", "Raul Santos", 887766555));
s.addVeiculo(new Veiculo("FGH-8901", "S60 T5", 2021, "21098765432", "Mariana Oliveira", 776655444));
s.addVeiculo(new Veiculo("LMN-5678", "M4 Competition", 2022, "45678901234", "Vitória Ferreira", 665544333));
s.addVeiculo(new Veiculo("OPQ-9012", "RX 350", 2019, "56789012345", "Diego Lima", 554433222));
s.addVeiculo(new Veiculo("RST-3456", "X6 xDrive", 2022, "67890123456", "Natália Martins", 443322111));
s.addVeiculo(new Veiculo("TUV-7890", "Model Y", 2021, "78901234567", "Eduardo Sousa", 332211000));
s.addVeiculo(new Veiculo("WXY-2345", "Civic Si", 2020, "89012345678", "Sophie Santos", 221100989));
s.addVeiculo(new Veiculo("ZAB-6789", "G-Wagon G550", 2023, "90123456789", "Rafaela Oliveira", 110099878));
s.addVeiculo(new Veiculo("CDE-0123", "Kona Electric", 2018, "01234567890", "Fábio Rodrigues", 998877667));
s.addVeiculo(new Veiculo("FGH-4567", "Optima LX", 2021, "12345678901", "Luana Almeida", 887766556));
s.addVeiculo(new Veiculo("IJK-8901", "Panamera", 2020, "23456789012", "Marcos Carvalho", 776655445));
s.addVeiculo(new Veiculo("LMN-2345", "X3 M", 2022, "34567890123", "Júlia Ferreira", 665544334));
s.addVeiculo(new Veiculo("OPQ-5678", "A7 Prestige", 2019, "45678901234", "Joana Lima", 554433223));
s.addVeiculo(new Veiculo("RST-9012", "Avalon Limited", 2022, "56789012345", "Pedro Martins", 443322112));
s.addVeiculo(new Veiculo("TUV-3456", "Mustang Mach-E", 2021, "67890123456", "Lívia Sousa", 332211001));
s.addVeiculo(new Veiculo("WXY-7890", "4 Series Gran Coupe", 2020, "78901234567", "Alexandre Carvalho", 221100990));
s.addVeiculo(new Veiculo("ZAB-2345", "XC90 T6", 2018, "89012345678", "Catarina Oliveira", 110099879));
s.addVeiculo(new Veiculo("CDE-6789", "Q3", 2021, "90123456789", "Roberto Rodrigues", 998877668));
s.addVeiculo(new Veiculo("FGH-0123", "Charger R/T", 2020, "01234567890", "Aline Almeida", 887766557));
s.addVeiculo(new Veiculo("IJK-4567", "Sorento SX", 2023, "12345678901", "João Silva", 776655446));
s.addVeiculo(new Veiculo("LMN-8901", "Elantra Limited", 2019, "23456789012", "Maria Santos", 665544335));
s.addVeiculo(new Veiculo("OPQ-1234", "F-150", 2022, "34567890123", "Pedro Oliveira", 554433224));
  ...
  public void qntNos(){
    System.out.println("Quantidade de veículos: " + s.contarVeiculos());
  }
}
